...
{
	public interface ForgotPasswordTaskImp
	{
		public void onPostExecute( );
	}
	
	private SignupInput				signupInput;
	private ForgotPasswordTaskImp	forgotPasswordTaskImp;
	private Activity				activity;
	private String					errorCode;
	
	public ForgotPasswordTask( Activity activity, SignupInput signupInput, ForgotPasswordTaskImp forgotPasswordTaskImp )
	{
		this.signupInput = signupInput;
		this.activity = activity;
		this.forgotPasswordTaskImp = forgotPasswordTaskImp;
	}
	...
	protected JSONObject doInBackground( Void... params )
	{
		...
		WebServiceJSON webService = new WebServiceJSON( URL.FORGOT_PASSWORD );
	...
	protected void onPostExecute( JSONObject result )
	{
		...
		{
			// MyOkDialog.showDialog( activity.getString( R.string.get_pass_success ), activity );
			forgotPasswordTaskImp.onPostExecute( );
		}
		else
		{
			MyOkDialog.showDialog( activity.getString( R.string.get_pass_nosuccess ), activity );
		}
	}
